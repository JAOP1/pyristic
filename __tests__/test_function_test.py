...
class TestBealeSuite(unittest.TestCase):
    ...
    def test_contraint(self):
        ...
        self.assertEqual(constraint1_beale.__doc__,"x1: -4.5 <= 3.00 <= 4.5 \n x2: -4.5 <= 0.50 <= 4.5")
...
class TestAckleySuite(unittest.TestCase):
    ...
    def test_contraint(self):
        ...
        self.assertEqual(constraint1_ackley.__doc__,"x1: -30 <= 3.00 <= 30 \n x2: -30 <= 0.50 <= 30 \n ")
...
class TestBukinSuite(unittest.TestCase):
    ...
    def test_contraint(self):
        ...
        self.assertEqual(constraint1_bukin.__doc__,"x1: -15 <= -6.00 <= -5 \n x2: -3 <= -3.00 <= 3 \n ")
...
class TestHimmelblauSuite(unittest.TestCase):
    ...
    def test_objective_function(self):
        ...
        #It should display the minimum value.
        self.assertAlmostEqual(himmelblau_function(np.array([-0.27085, -0.923039])),181.617, places=2)
    ...
    def test_contraint(self):
        ...
        self.assertEqual(constraint1_Himmelblau.__doc__,"x1: -5 <= -3.00 <= 5 \n x2: -5 <= -3.00 <= 5 \n ")
