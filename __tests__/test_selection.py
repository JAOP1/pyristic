...
class TestUtilsSelection(unittest.TestCase):
    ...
    def test_expected_value(self):
        ...
        self.assertListEqual(list(result), [0.5, 1.0, 1.5])
...
class TestMergeSelector(unittest.TestCase):
    ...
    def test_class_method(self):
        ...
        population_features["solutions"] = [
            [numpy.array([1, 2, 3]), numpy.array([2, 3, 1]), numpy.array([5, 3, 1])],
            [numpy.array([4, 3, 1]), numpy.array([4, 3, 1]), numpy.array([1, 1, 1])],
        ]
